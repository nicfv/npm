> [**BACK**](./Package%20Quirks.md) | **4** | [**NEXT**](./Custom%20Units%20and%20Dims.md) | Up next: Learn how to create an entirely new dimension and unit system from scratch, without using any defaults.
